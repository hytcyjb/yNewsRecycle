 ...
 * @time 2017/4/4 0:03
 */
public class CentreRecyclerAdapter extends RecyclerViewAdapter<newsClass> {

    public CentreRecyclerAdapter(Context context, List<newsClass> datas) {
        super(context, R.layout.homepager_item_pic2, datas);
    }
