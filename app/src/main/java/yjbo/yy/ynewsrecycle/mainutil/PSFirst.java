...
* @author yjbo
*/
public class PSFirst extends HorizontalScrollView {
...
//    private int mTabBackgroundResId = R.color.yellow;
    Context mcontext = null;
    public PSFirst(Context context) {
        this(context, null);
        mcontext = context;
    }

    public PSFirst(Context context, AttributeSet attrs) {
...
//            v.setBackgroundResource(mTabBackgroundResId);
            if (i == mTabCount - 1) {//最后一个按钮给它离“添加按钮”远一点
                ...
                v.setPadding(mTabPadding, v.getPaddingTop(), (int) dimension
                        , v.getPaddingBottom());
            } else {
